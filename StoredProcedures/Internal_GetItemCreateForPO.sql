CREATE OR ALTER PROCEDURE [dbo].[Internal_GetItemCreateForPO](@purchaseRequestLineItemIds VARCHAR(MAX), @purchaseOrderId INT = 0)
AS
BEGIN
    ...
    --Lấy các item đã được thêm vào po khác và các item đã nhận
    SELECT
